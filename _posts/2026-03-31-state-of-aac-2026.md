...
Spelling2Communicate (S2C) continues to be a topic of heated discussion. More S2C providers are appearing around the country, and despite the highly-contested nature of the approach, more families are defending its use in online communities. Whether you agree with the practice or not, it is clear that families feel a need unmet by traditional practitioners and strategies.
...
<div style='max-width: 600px; border: 1px solid #444; padding: 10px 20px 30px 10px; margin-bottom: 40px; margin-left: auto; margin-right: auto; border-radius: 5px; box-shadow: 5px 5px 15px #000;'>
  ...
  <div style='text-align: right; margin-bottom: 20px;'>
    ...
    <span style='display: inline-block; font-size: 26px; font-style: italic; font-family: Georgia; border-bottom: 1px solid #444; min-width: 200px;'>1.9 <span style='font-size: 18px;'>(1.9)</span></span>
    <br/>
  </div>
